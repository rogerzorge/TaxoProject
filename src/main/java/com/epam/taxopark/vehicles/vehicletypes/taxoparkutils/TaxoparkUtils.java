package com.epam.taxopark.vehicles.vehicletypes.taxoparkutils;
...
//    }
    ...
    public List<Automobile> fuelConsumptionFiltering(List<Automobile> list, int lowRangeValueFuelConsumption, int highRangeValueFuelConsumption) {
