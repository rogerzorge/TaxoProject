...
import com.epam.taxopark.vehicles.vehicletypes.derivedautomobileclasses.AutomobileExtendedList;
 ...
 */
public class JsonContentRetrieve implements ContentRetrieve {
    ...
    @Override
    public List<Automobile> getContent() {
